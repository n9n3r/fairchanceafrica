...
const STEPS = [
  ...
  },
  {
    ...
    body: "Buy 1 to 5 entries. Once you hit five, that's it for this LOT, no matter your budget.",
  },
  {
    n: "04",
  ...
  },
  {
    ...
    body: "When the LOT closes, the winning ticket is chosen by a secure, verifiable random process.",
  },
  {
    n: "06",
            ...
            <div className="flex flex-col gap-7">
              ...
              <div>
                ...
                <p className="text-sm text-ink-soft mt-3 leading-relaxed">
                  ...
                  LOT — no matter how much she's willing to spend.
                </p>
              </div>
            </div>
          </div>
